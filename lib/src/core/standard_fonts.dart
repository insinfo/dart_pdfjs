...
const Map<String, String> _stdFontMap = {
  ...
  'HelveticaLTStd-Bold': 'Helvetica-Bold',
  'Symbol-Bold': 'Symbol',
...
const Map<String, String> _fontNameToFileMap = {
...
const Map<String, String> _nonStdFontMap = {
  'Calibri': 'Helvetica',
...
const Map<String, bool> _serifFonts = {
  'Adobe Jenson': true,
  'Adobe Text': true,
  'Albertus': true,
  'Aldus': true,
...
const Map<String, bool> _symbolsFonts = {
  'Dingbats': true,
  'Symbol': true,
  'ZapfDingbats': true,
  'Wingdings': true,
...
const Map<int, int> _glyphMapForStandardFonts = {
  2: 10,
  3: 32,
  4: 33,
  5: 34,
...
Map<String, String> getStdFontMap() => _stdFontMap;
Map<String, String> getFontNameToFileMap() => _fontNameToFileMap;
Map<String, String> getNonStdFontMap() => _nonStdFontMap;
Map<String, bool> getSerifFonts() => _serifFonts;
Map<String, bool> getSymbolsFonts() => _symbolsFonts;
Map<int, int> getGlyphMapForStandardFonts() => _glyphMapForStandardFonts;
